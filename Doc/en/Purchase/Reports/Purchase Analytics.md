...
The Purchase Analytics report provides detailed insights into purchase data, categorized by supplier or item. This report helps in analyzing procurement trends and decision-making.

## Accessing Purchase Analytics

>     Navigate to Purchase > Report > Purchase Analytics.
...
The Purchase Analytics interface will open, allowing you to generate customized reports.
...
<img src="../../images/purchase analytics Report by Supplier.png" alt="purchase analytics Report by Supplier" style="border-radius: 10px; width: 70%; height: 70%; border: 0.5px solid #333;">

#### Additional Categorization:

<div style="text-align:left;">
    <ul>
        <li><strong>By Supplier Name:</strong> Choose a specific supplier from the dropdown menu, then click Show to display supplier-specific purchase data.</li>
